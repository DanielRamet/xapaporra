package com.xapaya.xapaporra.porra.service;
...
import com.xapaya.xapaporra.porra.repository.CurrentSeasonRepository;
import com.xapaya.xapaporra.porra.repository.MatchRepository;
import com.xapaya.xapaporra.porra.repository.TeamRepository;
...
public class FootballService {
    ...
    private final WebClient webClientFootballDataOrg;
    ...
    public List<Team> insertTeams(String competitionCode, int season) {
        ...
        if (c != null) {
            ...
            return webClientFootballDataOrg.get()
